					...
					<div class="navbar-collapse collapse">							
						<div class="menu">
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation"><a href="{{url('multi/index')}}" class="active">Home</a></li>
								<li role="presentation"><a href="{{url('multi/services')}}">Services</a></li>
								<li role="presentation"><a href="{{url('multi/blog')}}">Blog</a></li>
								<li role="presentation"><a href="{{url('multi/portfolio')}}">Portfolio</a></li>
								<li role="presentation"><a href="{{url('multi/contact')}}">Contact</a></li>						
							</ul>
						</div>
					</div>						
				</div>
